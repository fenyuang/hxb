  ...
  <div class="addGrop">
    ...
    <form name="visit">
      <div class="add_clue_form">
        <div class="form_name">
          <label for="name">回访人</label><input id="name" name="name" type="text" />
        </div>
        <div class="form_name">
        ...
        <div class="form_name">
          ...
          <select id="clueRank" name="class_id" >
            <option :value="list.id" v-for="list in classList">{{list.name}}</option>
          </select>
          <span class="triangle"></span>
        </div>
        <div class="form_name">
      ...
      <div class="add_clue_sub">
        <input type="button" value="提交" @tap="LINEvisit"/>
      </div>
    </form>
  </div>
  </HeaderNav>
